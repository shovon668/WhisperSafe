        ...
        <div className="container">
          ...
          {statistics && (
            <div className="notification is-info">
              ...
              {statistics.latestMessageTimestamp && (
                <p>Latest Message Timestamp: {formatDate(statistics.latestMessageTimestamp)}</p>
              )}
              ...
              {loading ? (
                ...
                <div className="columns is-multiline">
                  {messages.map((message) => (
                    <div key={message._id} className="column is-one-third">
                      <div className="box">
                        <p className="is-size-3 has-text-centered">{message.content}</p><br></br>
